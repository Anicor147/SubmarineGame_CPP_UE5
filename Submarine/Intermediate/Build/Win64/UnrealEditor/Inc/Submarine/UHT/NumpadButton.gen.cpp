...
struct Z_CompiledInDeferFile_FID_Submarine_Source_Submarine_Private_NumpadButton_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ANumpadButton, ANumpadButton::StaticClass, TEXT("ANumpadButton"), &Z_Registration_Info_UClass_ANumpadButton, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ANumpadButton), 927741575U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Submarine_Source_Submarine_Private_NumpadButton_h_4182838639(TEXT("/Script/Submarine"),
