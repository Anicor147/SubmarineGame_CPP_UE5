...
struct Z_Construct_UClass_AWaterLeak_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_WaterLeakSound_MetaData[] = {
		{ "Category", "WaterLeak" },
		{ "ModuleRelativePath", "Private/WaterLeak/WaterLeak.h" },
	};
	...
	static const UECodeGen_Private::FObjectPropertyParams NewProp_WaterLeakSound;
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AWaterLeak_Statics::NewProp_WaterLeakSound = { "WaterLeakSound", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AWaterLeak, WaterLeakSound), Z_Construct_UClass_USoundBase_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_WaterLeakSound_MetaData), NewProp_WaterLeakSound_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AWaterLeak_Statics::NewProp_WaterMecanic = { "WaterMecanic", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AWaterLeak, WaterMecanic), Z_Construct_UClass_AWaterMecanic_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_WaterMecanic_MetaData), NewProp_WaterMecanic_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AWaterLeak_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AWaterLeak_Statics::NewProp_WaterLeakSound,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AWaterLeak_Statics::NewProp_WaterMecanic,
};
...
struct Z_CompiledInDeferFile_FID_Submarine_Source_Submarine_Private_WaterLeak_WaterLeak_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AWaterLeak, AWaterLeak::StaticClass, TEXT("AWaterLeak"), &Z_Registration_Info_UClass_AWaterLeak, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AWaterLeak), 2330238659U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Submarine_Source_Submarine_Private_WaterLeak_WaterLeak_h_485204967(TEXT("/Script/Submarine"),
